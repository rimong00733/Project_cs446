    ...
    <div class="container">
      <div class="col-md-offset-2 col-md-8" style="margin-top : 8%;">
        <div class="panel panel-primary" style="background-color:#FBF8F8;">
          ...
          <div style="margin-left:10%;">
            <div class="form-group">
              <label class="radio-inline">
                <input type="radio" name="gender" id="gender" value="1"> ชาย
              </label>
              <label class="radio-inline">
                <input type="radio" name="gender" id="gender" value="2"> หญิง
              </label>
            </div>
          </div>
          <div><br></div>
          ...
          <div align="right"><a href="adduser.php">สมัครสมาชิกเพื่อรับสิทธิ์พิเศษต่างๆ>></a></div>
          </div>
        </div>
      </div>
    </div>
                    ...
                    //-----------------------------------Diet Planning-------------------------------------------
                        $('#cal3').click(function(){
                            ...
                            if(weightstd > weight){ //ลดน้ำหนัก
                               Result = resultTDEE-(((weightstd-weight)*6615)/day);
                            }else if(weightstd < weight){//เพิ่มน้ำหนัก
                               Result = resultTDEE+(((weight-weightstd)*6615)/day);
